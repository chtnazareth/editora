...
`escritor-aquisicao-agent` lidera; `escritor-pesquisa-agent` levanta dados de mercado. Modo subagente: o apoio escreve `contributions/escritor-pesquisa-agent.md` e o líder integra.
...
Despache `escritor-editor-chefe-agent` (§12a). Veredito PRONTO / NÃO-PRONTO, até 2 iterações antes de subir ao portão.
