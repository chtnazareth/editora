...
Modo pipeline: `escritor-desenvolvimento-agent` formula a premissa a partir da semente, `escritor-aquisicao-agent` a aperta até virar pitch. Cada elo vê o trabalho do anterior e avança o mesmo artefato.
