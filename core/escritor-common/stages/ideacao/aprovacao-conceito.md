...
agente_lider: escritor-editor-chefe-agent
agentes_apoio:
  - escritor-desenvolvimento-agent
  - escritor-aquisicao-agent
modo: mesa
produz:
  - parecer-de-conceito
consome:
...
Modo mesa: `escritor-editor-chefe-agent` conduz, com `escritor-desenvolvimento-agent` e `escritor-aquisicao-agent` na sala. Divergência entre eles é **registrada, não resolvida** — objeção de julgamento sobe ao autor no meio do estágio, não no fim.
