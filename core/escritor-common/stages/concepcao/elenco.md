...
agente_lider: escritor-personagens-agent
agentes_apoio:
...
`escritor-personagens-agent` lidera; `escritor-enredo-agent` confere se o que cada um quer é capaz de mover 27 capítulos.
