...
`escritor-mundo-agent` lidera. `escritor-pesquisa-agent` entra onde a regra depende de fato; `escritor-continuidade-agent` entra para dizer o que o texto já escrito estabeleceu.
