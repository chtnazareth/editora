...
id: translates
tipo: deterministico
comando: bun {{METODO}}/core/tools/editora-sensor.ts rodar --id translates --arquivo {{ARQUIVO}}
...
Consultivo: nenhum destes padrões é errado isoladamente — o verbo-filtro tem uso legítimo. O sensor reporta densidade e localização; a decisão é do autor no portão. Detalhe em `<obra>/.editora/registro/.sensores/<estagio>/translates-<correlator>.md`.
