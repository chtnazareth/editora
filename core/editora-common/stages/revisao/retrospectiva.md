...
Este é o estágio que fecha o laço de aprendizado do método. Sem ele, o Editora é só um checklist: é aqui que a correção do autor vira guardião permanente.
...
- **É verificável por máquina?** → manifesto novo em `core/sensors/` + analisador em `editora-sensores.ts`, e o id entra no `sensores:` do estágio pertinente
