...
Pipeline: `editora-enredo-agent` confere o executado contra o planejado; `editora-desenvolvimento-agent` diagnostica o que o desvio custou.
...
`editora-leitor-beta-agent` confronta o diagnóstico com a experiência de leitura. Emoji: 🏗️. Portão padrão (2 opções).
