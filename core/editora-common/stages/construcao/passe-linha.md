...
`editora-linha-agent`, com as convenções de prosa e a frase-exemplar à mão.
...
`editora-sensor.ts estagio --estagio passe-linha --unidade <unidade>`. Compare com os números do rascunho: média de palavras por frase, frases longas, ecos. O relatório mostra o **antes e depois**.
