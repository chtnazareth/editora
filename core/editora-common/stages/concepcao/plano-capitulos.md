...
escopos:
  ...
  - novela
  - retomada
revisor: editora-desenvolvimento-agent
...
`bun {{METODO}}/core/tools/editora-state.ts unidades --gerar 27`
...
`editora-desenvolvimento-agent` revisa (é ele quem cobra o arco). Emoji: 📋. Portão padrão.
