#!/usr/bin/env bun
/**
 * escritor-orchestrate.ts — o motor que o condutor obedece.
 *
...
import { registrar, registrarBloco } from "./escritor-audit.ts";
import {
  definirStatus,
  estagiosNoEscopo,
  guardaConclusao,
...
function main(): number {
  ...
  switch (comando) {
    ...
    default:
      console.error(
        "uso: escritor-orchestrate.ts <proximo|iniciar|reportar|status> [--estagio S] [--unidade U] [--resultado R] [--entrada T]",
      );
      return 2;
  }
}
