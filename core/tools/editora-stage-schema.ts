/**
 * editora-stage-schema.ts — contrato autoritativo do frontmatter de estágio.
 *
 * Porte de `core/tools/aidlc-stage-schema.ts`. Toda regra aqui é espelhada em
 * prosa em `core/editora-common/protocols/stage-definition.md`; se os dois
...
export function validarEstagio(e: Estagio, ctx: ContextoValidacao): Problema[] {
  ...
  if (/^(\/|aidlc-docs|\.editora)/.test(e.saidas.trim()))
    erro(
      "saidas",
