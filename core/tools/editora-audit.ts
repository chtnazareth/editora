/**
 * editora-audit.ts — trilha de auditoria da obra.
 *
 * Porte de `core/tools/aidlc-log.ts` + `aidlc-audit.ts`. Cada evento vira uma
 * linha em `<obra>/.editora/auditoria/<host>-<data>.md`. O arquivo é markdown
...
import { agoraISO, dirAuditoria } from "./editora-lib.ts";
