...
<!--
  GERADO por core/tools/escritor-harness.ts a partir de core/agents/escritor-pesquisa-agent.md
...
3. `<metodo>/core/knowledge/escritor-pesquisa-agent/`
